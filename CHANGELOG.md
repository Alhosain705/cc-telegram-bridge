...
**Decision:** The governing UX rule is now task-based: every onboarding and release path must be walked from the public entry point as a non-technical first-time user. Technical existence checks do not satisfy this gate. The next required action must be visible, plain-language, and directly clickable. The durable contract is recorded in `docs/adr/0002-non-technical-onboarding-gate.md`.
**Evidence:** Internal content revision `9820fc63602b3a7caabc30057dcfe2d692a37c45` and public content revision `529c0ff1911d64c0404dc623cec54f155124ed9e` contain identical README, manual, and regression-test files. The remediation heads after adding ADR 0002 were internal `b96cb007ece5a9a13a1fdf3145b7e1b7d50486b5` and public `a5aa2ba01628955fb0fa2dec68d87d9f80b27b5f`. `npm run check` passed; `npm test` passed **111/111**. Anonymous live-path and visual verification are recorded after publication in project truth.
